...
export class DementiaSqlightService {
  ...
  public refreshDataSet() {
     console.log("platform ready in refreshDataSet");
  ...
  ////////////////////////// QUERIES FOR TESTS //////////////////////
   public insertCreateTest(createTest: CreateTest) {
      console.log("platform ready in insertCreateTest");
   ...
   public getCreatedTests(user_id: string) {
      console.log("platform ready in getcreatedtests");
   ...
   public deleteTest(id: number) {
      console.log("platform ready in deletetest");
  ...
  public getBySection(section: number, id: number) {
      console.log("platform ready in getbysection");
  ...
  public add(test: Test) {
      console.log("platform ready in add");
  ...
  public update(test: Test) {
      console.log("platform ready in update");
  ...
  public deleteAnswers(id: number){
      console.log("platform ready in delete answer");
